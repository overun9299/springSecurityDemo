...
CREATE TABLE `login`  (
  ...
  `user_agent` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '浏览器标识',
...
CREATE TABLE `menu`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '资源图标',
  `name` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '资源名字',
  `authority` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '权限',
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '资源路径',
  ...
  `modified_time` datetime(0) DEFAULT NULL COMMENT '修改时间',
  `status` int(11) DEFAULT 1 COMMENT '1：正常',
  `is_delete` tinyint(4) DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `role`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '角色名字(英文）',
  `name_remark` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '角色描述',
  `created_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `modified_time` datetime(0) DEFAULT NULL COMMENT '修改时间',
  `status` int(11) DEFAULT 1 COMMENT '1：正常',
  `is_delete` tinyint(4) DEFAULT 0 COMMENT '是否删除',
...
CREATE TABLE `user`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `nickname` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '名字',
  `username` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '用户名',
  ...
  `create_date` datetime(0) DEFAULT NULL COMMENT '注册时间',
  `modified_time` datetime(0) DEFAULT NULL,
  `status` int(11) DEFAULT 1 COMMENT '1：正常\r\n2：停用',
  `is_delete` tinyint(4) DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
